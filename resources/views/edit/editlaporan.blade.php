...
<div class="card shadow col-6 mx-auto" style="margin-bottom: 10%; margin-top: 5%">
    ...
    <div class="card-body">
        ...
        <div class="container">
            <form action="/dashboard/mahasiswa/laporan/update" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="mb-3">
                    ...
                    <input class="form-select form-select-lg mb-3 form-control" type="text" name="laporan" required="required" value="{{ $p->nama_laporan }}">
                </div> 
                <div class="mb-3">
